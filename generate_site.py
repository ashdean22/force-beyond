#!/usr/bin/env python3
"""
ForceBeyond Static Site Generator
...
KEYWORD_PAGES = [
    {
        ...
        "meta_desc": "ForceBeyond provides custom superalloy casting services using vacuum investment casting for aerospace, power generation, and nuclear applications. ISO 9001 certified. Request a quote.",
        ...
        "faqs": [
            ...
            {"q": "What quality certifications do you hold?", "a": "ForceBeyond is ISO 9001:2015 certified with processes aligned to AS9100 aerospace quality standards. We maintain full material traceability, PPAP documentation, and can support IATF 16949 requirements for automotive applications."},
        ],
    },
    {
        ...
        "meta_desc": "Custom superalloy forging services from ForceBeyond. Hot forging and isothermal forging of nickel-based and cobalt-based alloys for aerospace, energy, and defense. Get a quote.",
    ...
    },
    {
        ...
        "meta_desc": "Expert superalloy CNC machining services from ForceBeyond. 5-axis precision machining of Inconel, Hastelloy, and other nickel-based alloys. ISO 9001 certified.",
    ...
    },
    {
        ...
        "meta_desc": "ForceBeyond specializes in Inconel investment casting including Inconel 718 and 625. Vacuum precision casting for aerospace, gas turbines, and nuclear applications.",
    ...
    },
    {
        ...
        "meta_desc": "ForceBeyond provides custom Inconel forging services including Inconel 718 and 625. Hot forging and isothermal forging for aerospace, oil & gas, and power generation.",
    ...
    },
    {
        ...
        "meta_desc": "Custom Inconel 718 forging from ForceBeyond. Precision hot forging and isothermal forging of Inconel 718 for turbine discs, fasteners, and structural components.",
    ...
    },
    {
        ...
        "meta_desc": "Precision Inconel 718 CNC machining from ForceBeyond. Expert machining of the world's most popular superalloy for aerospace, energy, and defense applications.",
    ...
    },
    {
        ...
        "meta_desc": "Custom Inconel 625 forging services from ForceBeyond. Superior corrosion resistance for marine, chemical processing, and oil & gas applications. Request a quote.",
    ...
    },
    {
        ...
        "meta_desc": "Expert Inconel 625 CNC machining from ForceBeyond. Precision turning, milling, and drilling for marine, chemical, and oil & gas components. ISO 9001 certified.",
    ...
    },
    {
        ...
        "meta_desc": "ForceBeyond provides custom titanium investment casting services for aerospace, medical, and defense applications. Grade 2, Grade 5 Ti-6Al-4V, and more.",
    ...
    },
    {
        ...
        "meta_desc": "Custom titanium forging services from ForceBeyond. Hot forging of Ti-6Al-4V and other titanium alloys for aerospace, defense, and medical applications.",
    ...
    },
    {
        ...
        "meta_desc": "Expert titanium CNC machining services from ForceBeyond. Precision milling, turning, and drilling of Ti-6Al-4V and other grades for aerospace and medical applications.",
    ...
    },
    {
        ...
        "meta_desc": "ForceBeyond provides high-quality aluminum and zinc die casting services with machines from 180 to 2,000 metric tons. From prototype to production. Request a quote.",
    ...
    },
    {
        ...
        "meta_desc": "ForceBeyond provides high-quality investment casting (lost-wax casting) in stainless steel, titanium, Inconel, and more. From grams to 1 metric ton. ISO 9001 certified.",
...
HUB_PAGES = [
    {
        ...
        "meta_desc": "Complete guide to superalloys from ForceBeyond. Casting, forging, and machining of nickel-based, cobalt-based, and iron-based superalloys for aerospace, energy, and defense.",
    ...
    },
    {
        ...
        "meta_desc": "Complete Inconel manufacturing guide from ForceBeyond. Casting, forging, and machining of Inconel 718, 625, and other grades. Aerospace, energy, oil & gas applications.",
    ...
    },
    {
        ...
        "meta_desc": "Complete titanium manufacturing guide from ForceBeyond. Investment casting, forging, and CNC machining of Ti-6Al-4V and other grades for aerospace, medical, and defense.",
...
AI_PAGES = [
    {
        ...
        "meta_desc": "Comprehensive comparison of Inconel 718 and Inconel 625. Properties, applications, cost, and selection criteria to help you choose the right alloy. Expert guide from ForceBeyond.",
    ...
    },
    {
        ...
        "meta_desc": "Expert comparison of casting vs forging for superalloy components. Learn when to cast vs forge Inconel, titanium, and other high-temperature alloys. Guide from ForceBeyond.",
    ...
    },
    {
        ...
        "meta_desc": "Interactive guide to selecting the right superalloy for your application. Compare Inconel, Hastelloy, Waspaloy, titanium, and more. Expert resource from ForceBeyond.",
    ...
    },
    {
        ...
        "meta_desc": "Expert guide to overcoming the top 5 challenges in CNC machining superalloys including Inconel, Hastelloy, and titanium. Tool wear, heat, work hardening solutions from ForceBeyond.",
...
<head>
    ...
    {{
      ...
      "email": "contact@forcebeyond.com",
      "sameAs": ["https://www.linkedin.com/company/forcebeyond-llc"]
    }}
    </script>
</head>'''
...
def footer_html():
    ...
    <div class="container">
        ...
        <div class="footer-bottom">
            <p>&copy; 2026 ForceBeyond. All rights reserved. | New Castle, Delaware, USA</p>
...
def generate_homepage():
    ...
    html = f'''{head_html("Superalloy Casting, Forging &amp; Machining | Total Manufacturing Solutions", "ForceBeyond is a manufacturing total solution provider specializing in superalloy casting, Inconel forging, titanium machining, die casting, and investment casting. ISO 9001 certified. US headquarters.", "superalloy casting, inconel casting, titanium forging, die casting, investment casting, CNC machining, manufacturing", "/")}
<body>
{header_html()}
...
def generate_contact_page():
    html = f'''{head_html("Contact Us – Request a Quote", "Contact ForceBeyond for a free quote on superalloy casting, Inconel forging, titanium machining, die casting, and more. Response within 24 hours.", "contact forcebeyond, request quote, manufacturing quote", "/contact/")}
<body>
{header_html()}
{trust_strip()}
    ...
    <div class="container content-grid">
        ...
        <aside class="content-sidebar">
            <div class="sidebar-card">
                ...
                <p><strong>Email:</strong><br><a href="mailto:contact@forcebeyond.com">contact@forcebeyond.com</a></p>
...
def generate_about_page():
    html = f'''{head_html("About ForceBeyond – Company Profile", "ForceBeyond is a manufacturing total solution provider headquartered in New Castle, Delaware. ISO 9001:2015 certified with 30+ years experience in casting, forging, and machining.", "about forcebeyond, company profile, manufacturing company delaware", "/about/")}
<body>
{header_html()}
{trust_strip()}
...
<section class="section">
    <div class="container">
        <div class="about-content">
            ...
            <p>ForceBeyond, headquartered in New Castle, Delaware, is a manufacturing total solution provider encompassing engineering design, product development, production, and logistics. We partner with our customers by offering superior quality products and comprehensive supply chain management services.</p>
...
def generate_services_index():
    ...
    html = f'''{head_html("Services – Casting, Forging, Machining &amp; Supply Chain", "Complete manufacturing services from ForceBeyond: superalloy casting, Inconel forging, titanium machining, die casting, investment casting, and supply chain management.", "manufacturing services, casting forging machining", "/services/")}
<body>
{header_html()}
{trust_strip()}
<section class="page-hero">
...
def generate_resources_index():
    ...
    html = f'''{head_html("Resources &amp; Technical Guides", "Technical resources, comparison guides, and expert articles on superalloy casting, forging, and machining from ForceBeyond.", "superalloy resources, manufacturing guides, technical articles", "/resources/")}
<body>
{header_html()}
{trust_strip()}
<section class="page-hero resource-hero">
...
def generate_industries_page():
    ...
    html = f'''{head_html("Industries Served – Aerospace, Oil & Gas, Power, Medical & More", "ForceBeyond serves aerospace, oil and gas, power generation, nuclear, automotive, mining, medical, marine, chemical, and defense industries with precision casting, forging, and machining.", "manufacturing industries, aerospace casting, oil gas forging", "/industries/")}
<body>
{header_html()}
{trust_strip()}
<section class="page-hero">
...
def build():
    ...
    print("Building ForceBeyond site...")
